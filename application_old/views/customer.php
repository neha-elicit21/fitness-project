                              ...
                              <tbody>
                                 <?php
                                    ...
                                    ?>
                                     ...
                                     ?>
                                      <td><a href="<?php echo base_url("index.php/users/edit_trainee").'/'.$key['ID']; ?>" title="edit"><i class="fa fa-pencil-square" aria-hidden="true"></i></a> <a href="<?php echo base_url("index.php/users/delete_trainee").'/'.$key['ID']; ?>" title="edit"><i class="fa fa-trash" aria-hidden="true"></i></a> </td>
                                    <?php
                                     echo '</tr>';
