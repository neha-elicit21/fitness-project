	...
	<div class="custom-scroll custom-scroll-light">
		...
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				...
				<ul>
					...
					<li><a href="<?php echo base_url(); ?>index.php/users/customer">Trainee</a></li>
		...
		<!-- 	<li class="with-sub">
				...
				<ul>
					...
					<li><a href="<?php echo base_url(); ?>index.php/booking/ongoing">OnGoing</a></li>

					<li><a href="<?php echo base_url(); ?>index.php/booking/completed">Completed</a></li>
...
<!-- 			<li class="menu-title">Transaction</li>
		...
		<li class="menu-title">Workout</li>
				...
				<li class="with-sub">
					...
					<ul>
						<li><a href="<?php echo base_url(); ?>index.php/workout">Workout</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/workout/workout_plan">Workout Plan</a></li>
				...
				<li class="with-sub">
					...
					<ul>
						<li><a href="<?= base_url('index.php/workout/report') ?>">Report</a></li>
					</ul>
			...
			<!-- <li class="with-sub">
				...
				<ul>
					...
					<li><a href="<?php echo base_url(); ?>index.php/statement/overallStatement">Overall Booking Statements</a></li>

					<li><a href="<?php echo base_url(); ?>index.php/statement/trainerStatement">Trainer Statement</a></li>

					<li><a href="<?php echo base_url(); ?>index.php/statement/dailyStatement">Daily Statement</a></li>

					<li><a href="<?php echo base_url(); ?>index.php/statement/monthlyStatement">Monthly Statement</a></li>

					<li><a href="<?php echo base_url(); ?>index.php/statement/yearlyStatement">Yearly Statement</a></li>
			...
			<li class="with-sub">
				...
				<ul>
					...
					<li><a href="<?php echo base_url(); ?>index.php/account/approve">Approved</a></li>

					<li><a href="<?php echo base_url(); ?>index.php/account/unapprove">Unapproved</a></li>
			...
			<!-- 	<li>
				...
				<a href="<?php echo base_url(); ?>index.php/statement/releasePayment" class="waves-effect  waves-light">
			...
			<li class="with-sub">
				...
				<ul>
					...
					<li><a href="<?php echo base_url(); ?>index.php/statement/trainerWallet">Trainer Wallet</a></li>

					<li><a href="<?php echo base_url(); ?>index.php/statement/transactionHistory">Transaction History</a></li>
			...
			<li class="compact-hide">
				...
				<a href="<?php echo base_url(); ?>index.php/SignOut/"></i></span>
