...
<!-- Section Footer Scripts -->
   ...
   <!-- Main jQuery -->
   <script src="<?=base_url('front_end/plugins/jquery/jquery.js')?>"></script>
   <!-- Bootstrap 4.3.1 -->
   <script src="<?=base_url('front_end/plugins/bootstrap/js/bootstrap.min.js')?>"></script>
   <!-- Slick Slider -->
   <script src="<?=base_url('front_end/plugins/slick-carousel/slick/slick.min.js')?>"></script>
   <!--  Magnific Popup-->
   <script src="<?=base_url('front_end/plugins/magnific-popup/dist/jquery.magnific-popup.min.js')?>"></script>
   <!-- Form Validator -->
   <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery.form/3.32/jquery.form.js"></script>
   <script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.11.1/jquery.validate.min.js"></script>
   <!-- Google Map -->
   <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu5nZKbeK-WHQ70oqOWo-_4VmwOwKP9YQ"></script>
   <script src="<?=base_url('front_end/plugins/google-map/gmap.js')?>"></script>

   <script src="<?=base_url('front_end/js/script.js')?>"></script>
