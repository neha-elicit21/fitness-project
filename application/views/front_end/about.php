	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-3 col-md-6">
				<img src="<?=base_url('front_end/images/about/img-6.jpg')?>" alt="" class="img-fluid">
			</div>
			<div class="col-lg-3 mt-lg-4 col-md-6">
				<img src="<?=base_url('front_end/')?>images/about/img-7.jpg" alt="" class="img-fluid">
			</div>
	...
	<div class="container-fluid p-0">
		<div class="row no-gutters portfolio-gallery">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-01.jpg" class="popup-gallery">
					<img src="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-01.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-02.jpg" class="popup-gallery">
					<img src="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-02.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-03.jpg" class="popup-gallery">
					<img src="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-03.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-04.jpg" class="popup-gallery">
					<img src="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-04.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-05.jpg" class="popup-gallery">
					<img src="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-05.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-06.jpg" class="popup-gallery">
					<img src="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-06.jpg" alt="" class="img-fluid">
				</a>
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<a href="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-08.jpg" class="popup-gallery">
					<img src="<?=base_url('front_end/')?><?=base_url('front_end/')?>images/gallery/gallery-08.jpg" alt="" class="img-fluid">
				</a>
			</div>
		</div>
	</div>
