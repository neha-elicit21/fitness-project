		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?=base_url('front_end/images/services/service-1.jpg')?>" class="mr-3 w-50" alt="...">

				  <div class="media-body">
				    <span class="letter-spacing text-sm">Fitness</span>
				    <h4 class="mb-3 text-uppercase">Keep Fitness</h4>
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?=base_url('front_end/images/services/service-2.jpg')?>" class="mr-3 w-50" alt="...">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?=base_url('front_end/images/services/service-3.jpg')?>" class="mr-3 w-50" alt="...">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?=base_url('front_end/images/services/service-4.jpg')?>" class="mr-3 w-50" alt="...">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?=base_url('front_end/images/services/service-5.jpg')?>" class="mr-3 w-50" alt="...">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="media align-items-center mb-4">
				  <img src="<?=base_url('front_end/images/services/service-6.jpg')?>" class="mr-3 w-50" alt="...">
