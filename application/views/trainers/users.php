                          ...
                          <!--   <div class="box-header">
                            ...
                            <table id="example2" class="table table-bordered table-hover text-center">
                                ...
                                <tr>
                                  ...
                                  <?php }
                                    ?>
                                    <td><a href="<?php echo base_url("index.php/trainers/edit_trainee").'/'.$value['ID']; ?>" title="edit"><i class="fa fa-pencil-square" aria-hidden="true"></i></a> <a href="<?php echo base_url("index.php/trainers/delete_trainee").'/'.$value['ID']; ?>" title="edit"><i class="fa fa-trash" aria-hidden="true"></i></a> </td>
                                </tr>
                            <?php $num++; } ?>
