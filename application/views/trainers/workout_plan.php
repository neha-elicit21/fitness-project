  ...
  <div id="content-header" class="page-title">
    ...
    <h2>Workout Plans</h2>
      <div class="span6 box-right">
         <a href="<?=base_url('trainer/workout/workout_plan_create');?>" class="btn" name="new_vendor">Add New</a>                  
      </div>
  </div>
                      ...
                      <table class="table table-bordered data-table" id="tainertable">
                        ...
                        <tbody>
                          ...
                          foreach ($trainees as $trainee ) { ?>
                            ...
                            <td><a href="<?=isset($trainee['id'])?base_url('trainer/workout/workout_plan_edit/'.$trainee['id']):'#'?>" title="edit"><i class="fa fa-pencil-square" aria-hidden="true"></i></a> 
