	...
	<div class="custom-scroll custom-scroll-light">
		...
		<ul class="sidebar-menu">
			...
			<li>
				...
				<a href="<?= base_url('trainers'); ?>" class="waves-effect  waves-light">
			...
			<li>
				...
				<a href="<?= base_url('trainers/users'); ?>" class="waves-effect  waves-light">
			...
			<li class="menu-title">Workout</li>
				...
				<li class="with-sub">
					...
					<ul>
						<li><a href="<?php echo base_url(); ?>trainers/workout">Workout</a></li>
						<li><a href="<?php echo base_url(); ?>trainers/workout_plan">Workout Plan</a></li>
			...
			<li>
				<a href="<?= base_url('trainers/report'); ?>" class="waves-effect  waves-light">
					<span class="s-icon"><i class="fa fa-file" aria-hidden="true"></i></span>
					<span class="s-text">Report</span>
				</a>
			</li>
			<li>
				<a href="<?= base_url('trainers/custom_workout'); ?>" class="waves-effect  waves-light">
					<span class="s-icon"><i class="fa fa-user" aria-hidden="true"></i></span>
			...
			<li>
				...
				<a href="<?php echo base_url(); ?>SignOut/" class="waves-effect  waves-light">
				...
				<li class="nav-item dropdown hidden-sm-down">
					...
					<div class="dropdown-menu dropdown-menu-right animated fadeInUp">
                        <a href="#" class="dropdown-item">
							<i class="ti-user mr-0-5" aria-hidden="true"></i>
